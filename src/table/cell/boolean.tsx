...
export function BooleanCell({
  ...
  return (
    ...
    >
      <Switch.Thumb className="h-full block aspect-square rounded-full bg-light transition-aspect data-[state=unchecked]:translate-x-0 peer-disabled:pointer-events-none duration-200 group-active:aspect-[1.2/1] data-[state=checked]:translate-x-16" />
    </Switch.Root>
  );
}

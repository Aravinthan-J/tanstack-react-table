...
import { RowDragHandleCell } from "./virtualrow";
  ...
  header: ({
    ...
    return (
      <div className="pl-2 flex justify-center w-full cursor-pointer group/header">
        <span
          className={`group-hover/header:hidden ${!showCheckBox ? "flex" : "hidden"}`}
        >
          #
        </span>
        <span
          className={`group-hover/header:flex ${showCheckBox ? "flex" : "hidden"}`}
        >
          <Checkbox
            onChange={() => {
  ...
  cell: ({
    ...
    return (
      ...
      >
        ...
        <span
          className={`group-hover/tablerow:hidden ${!showCheckBox ? "flex" : "hidden"}`}
        >
          {index + 1}
        </span>
        <span
          className={`group-hover/tablerow:flex ${showCheckBox ? "flex" : "hidden"}`}
        >
          <Checkbox

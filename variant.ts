...
export const InputVariants = tv({
  slots: {
    base: "border-1 border-solid border-transparent !bg-inherit group-hover/table_cell:border-gray-200 focus:border-primary-500 [&:not([data-disabled]):not([data-readonly]):hover]:border-primary-400"
  },
  variants: {
    isError: {
      true: {
...
export const MultiLineVariants = tv({
  slots: {
    base: "m-4 h-full resize-none p-8 border-1 border-solid border-transparent !bg-inherit group-hover/table_cell:border-gray-200 focus:border-primary-500 [&:not([data-disabled]):not([data-readonly]):hover]:border-primary-400"
  },
  variants: {
    isError: {
      true: {
